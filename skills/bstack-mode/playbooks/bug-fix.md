...
5. Commit the failing repro or test before the fix when there is a cheap local test path (`principles/sequence-verifiable-units.md`). Skip it when the test would be expensive or brittle, and say why.
